...
{
    bool CreateSummits(Guid catalogueId, IEnumerable<SummitCommand> summits);
    ...
    bool UpdateSummits(Guid catalogueId, IDictionary<Guid, SummitCommand> summitsToUpdate);
    bool DeleteSummits(Guid catalogueId, IEnumerable<Guid> ids);
